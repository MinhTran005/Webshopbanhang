...
using Webshopbanhang.Utilities.Exceptions;
   ...
   public class ManageProductService : IManageProductService
    {
        ...
        public async Task<int> Create(ProductCreateRequest request)
        {
            ...
            {
                Price = request.Price,
                OrigingalPrice = request.OriginalPrice,
                Stock = request.Stock,
                ViewCount = 0,
        ...
        {
            var product = await _context.Products.FindAsync(productId);
            if (product == null) throw new WebshopException($"cannot find a product:{productId}");
